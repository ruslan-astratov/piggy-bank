...
_momentDefault.default().format();
console.log(_momentDefault.default().format());
...
function calcMonths() {
  let start = _momentDefault.default().format('YYYY-MM');
  let end = period.innerHTML;
  let a = _momentDefault.default(start, "YYYY-MM");
  let b = _momentDefault.default(end, "YYYY-MM");
...
} else // В противном случае, если хотя бы один из инпутов НЕ пустой, то ничего не срабатывает
  {
...
},{"moment":"5Hi32","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"5Hi32":[function(require,module,exports) {
var define;
// ! moment.js
// ! version : 2.29.1
...
},{}]},["A7H4y","4ee1I"], "4ee1I", "parcelRequire427e")
